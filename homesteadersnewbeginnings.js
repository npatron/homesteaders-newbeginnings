...
function (dojo, declare) {
    ...
    return declare("bgagame.homesteadersnewbeginnings", ebg.core.gamegui, {
        ...
        */
        ...
        /**
         *  solution to speed up loading.
         */ 
        omitImages: function() {
            if (this.number_auctions<5){
                this.dontPreloadImage()
            }
        ...
        formatBuildingIncome: function(b_id, b_key){
            ...
            if (b_info.inc != null){
                if (b_info.inc.silver =='x'){
                    ...
                    inc_vals = dojo.string.substitute(_('Pay off ${loan}'), {loan:this.tkn_html.loan}) + '<br>';
                } else {
                ...
                switch (log.action){
                    ...
                    case 'updateResource':
                        if (log.amt < 0){
                            ...
                            for(let j = 0; j < log.amt; j++){
                                this.slideTemporaryObject( this.tkn_html[type], 'limbo', 'board', player_zone, 500 , 50*(delay++) );
                                if (updateResource){
                                    this.incResCounter(p_id, log.type, 1);
                                }
                            }
