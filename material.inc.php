...
$this->event_info = array(
  1 => array(
    ...
    'stage' => STAGE_SETTLEMENT,
    'tt'    => clienttranslate('The winner of Auction 1 builds for one resource less (their choice)'),
    'auc'   => array(1),
  ...
  2 => array(
    ...
    'stage' => STAGE_SETTLEMENT,
    'tt'    => clienttranslate('Auction 1 is unavailable this round'),
    'auc'   => array(1),
  ...
  5 => array(
    ...
    'stage' => STAGE_SETTLEMENT,
    'tt'    => clienttranslate('Auction 1 also gives build (Any Type)'),
    'auc'   => array(1),
  ...
  6 => array(
    ...
    'stage' => STAGE_SETTLEMENT,
    'tt'    => clienttranslate('Auction 1 also gives ${worker}'),
    'auc'   => array(1),
  ...
  10 => array(
    ...
    'stage' => STAGE_SETTLEMENT,
    'tt'    => clienttranslate('Auction 1 also gives ${track}'),
    'auc'   => array(1),
    'auc_b' => EVT_AUC_TRACK,
  ),
  11 => array(
  ...
  22 => array(
    'name'  => clienttranslate('Industrial Dominance'),
    'stage' => STAGE_CITY,
